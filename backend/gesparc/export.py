...
EXPORTS: dict[str, Export] = {
    ...
    "achats-carburant": Export(
        fn=queries.list_achats_carburant,
        filename="achats-carburant",
        str_params=("search", "num_fourn", "num_parc", "statut"),
        columns=(
            ("reference", "Référence"),
    ...
    "cartes-carburant": Export(
        fn=queries.list_cartes_carburant,
        filename="cartes-carburant",
        str_params=("search", "num_struct", "num_parc", "statut"),
        columns=(
            ("num_caa", "N° carte"),
            ("structure", "Structure"),
            ("parc", "Parc / UGP"),
            ...
            ("station", "Station"),
            ("solde", "Solde"),
            ("date_octroi", "Date octroi"),
            ("date_expiration", "Date expiration"),
            ("statut", "Statut"),
        ),
    ),
    "emprunts": Export(
        fn=queries.list_emprunts,
        filename="emprunts",
        str_params=("search", "statut"),
        columns=(
            ("num_emp", "N° emprunt"),
